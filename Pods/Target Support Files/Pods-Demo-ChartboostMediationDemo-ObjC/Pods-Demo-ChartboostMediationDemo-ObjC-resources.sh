...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ChartboostSDK/ChartboostSDK.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ChartboostSDK/ChartboostSDKResources.bundle"
fi
